    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Sửa chuyển kho</h2>
            </div>
            <div class="modal-body">
                ...
                <form action="" id="form-edit" method="POST" role="form">
                    ...
                    <div class="form-group">
                        <input required type="tel" class="form-control" placeholder="Mã kho mới" name='id_warehouse' id="id_warehouse-edit">
                    </div>
                    <div class="form-group">
                        {{-- <label for="email">Tên Kho:</label> --}}
                        <input required type="text" class="form-control" placeholder="Mã kho cũ" name='id_warehouse_old' id="id_warehouse_old-edit">
                    </div>
                    <div class="form-group">
                        {{-- <label for="email">Tên Kho:</label> --}}
                        <input required type="date" class="form-control" placeholder="Ngày chuyển" name='date_transfer' id="date_transfer-edit">
                    </div>
                    <div class="form-group">
